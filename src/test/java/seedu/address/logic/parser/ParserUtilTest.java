...
public class ParserUtilTest {
    ...
    public void parseName_validValueWithoutWhitespace_returnsName() throws Exception {
        Doctor expectedName = new Doctor(VALID_NAME);
    ...
    @Test
    public void parseDoctor_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseDoctor((String) null));
    }

    @Test
    public void parseDoctor_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseDoctor(INVALID_DOCTOR));
    }
