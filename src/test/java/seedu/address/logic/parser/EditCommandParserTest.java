...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_DOCTOR_DESC + INVALID_EMAIL_DESC
                        + VALID_ADDRESS_AMY + VALID_DATETIME_AMY + VALID_PHONE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        //after Doctor: PHONE_DESC_BOB
        String userInput = targetIndex.getOneBased() + DOCTOR_DESC_BOB + PHONE_DESC_AMY + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + DATETIME_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
        //after Doctor:.withDoctor(VALID_DOCTOR_AMY).withPhone(VALID_PHONE_BOB)
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDoctor(VALID_DOCTOR_BOB)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        //after doctor: String userInput = targetIndex.getOneBased()
        // + DOCTOR_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_AMY;
        String userInput = targetIndex.getOneBased() + DOCTOR_DESC_BOB + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY;

        //after doctor: EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder()
        // .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).build();
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder()
                .withDoctor(VALID_DOCTOR_BOB).withPhone(VALID_PHONE_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + DOCTOR_DESC_AMY + PHONE_DESC_AMY + ADDRESS_DESC_AMY
